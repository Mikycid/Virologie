...
Sw3NtProtectVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08710ADB3h        ; Load function hash into ECX.
...
Sw3NtWriteVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 04D9689DBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateThreadEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 098B1C656h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 05DA34E0Ch        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAllocateVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 009843533h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFreeVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0099AC7DDh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForSingleObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00438F744h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDelayExecution PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 04E2248B3h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
